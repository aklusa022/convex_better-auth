...
function SidebarFooter({
  ...
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "flex flex-col gap-2 p-2 sticky bottom-0 pointer-events-none",
        className
      )}
      {...props}
    >
